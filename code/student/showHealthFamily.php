    ...
    <section class="principal">
        ...
        <div class="flex">
            ...
            <div class="text-center my-4">
                <a href="downloadTemplateHealthFamily.php" class="btn btn-success btn-lg mr-3" title="Descargar plantilla Excel para carga masiva">
        ...
        if ($res) {
            ...
            if ($result) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ';
                    echo '
                        <td data-label="APLICAR"><a href="addHealthFamily.php?num_doc_est=' . $row['num_doc_est'] . '"target="_blank"><img src="../../img/aplicar.png" width=28 height=28></a></td>
                        ';
                    echo '
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="uploadHealthFamily.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <ol class="mb-0 mt-2">
                                ...
                                <li>Complete los datos de familia y salud de los estudiantes</li>
